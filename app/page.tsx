...
const processSteps = [
  {
    ...
    title: "전화 상담",
    description:
      "상품리뷰·상품리뷰보호소 상담 전화(0505-707-0401)로 연락 주세요. 반려견의 나이, 성격, 파양 배경을 비밀 보장 하에 차분하게 상담해 드립니다.",
  },
  {
    step: "2",
    title: "맞춤 절차 안내",
    description:
      "상품리뷰보호소·상품리뷰보호센터 연계 방법을 보호자님 상황에 맞게 설명합니다. 파양 전 서로 충분히 이야기하며 반려견에게 맞는 길을 찾습니다.",
  },
  {
    step: "3",
    title: "보호소 입소",
    description:
      "상품리뷰센터 연계 보호소에 입소하면 정서 안정과 일상 케어가 시작됩니다. 유기동물보호소 기준에 맞는 편안한 공간에서 반려견을 보호합니다.",
  },
  {
    step: "4",
    title: "입양·무료분양 연계",
    description:
      "준비가 되면 책임 있는 가정에 강아지무료분양을 연계합니다. 상품리뷰 이후에도 입양 가정과의 안부 확인을 이어갑니다.",
  },
];
...
const serviceItems = [
  {
    title: "상품리뷰 상담",
    text: "예상치 못한 상황으로 반려견을 맡기셔야 할 때, 상품리뷰 전문 상담으로 신중하고 따뜻한 절차를 안내해 드립니다.",
  },
  {
    title: "상품리뷰보호소·상품리뷰보호소 연계",
    text: "상품리뷰보호소 및 상품리뷰보호소와 협력하여 반려견이 보호소에서도 마음이 놓일 수 있는 환경을 준비합니다.",
  },
  {
    title: "상품리뷰센터·상품리뷰보호센터 안내",
    text: "상품리뷰센터 등록부터 상품리뷰보호센터 입소, 필요한 관리까지 단계별로 친절하게 안내합니다.",
  },
  {
...
const promises = [
  {
    num: "01",
    title: "따뜻하게 맞이합니다",
    text: "상품리뷰·상품리뷰보호소 상담은 보호자님의 마음을 먼저 이해합니다. 반려견과 사람 모두를 위한 방법을 함께 찾습니다.",
  },
  {
    num: "02",
    title: "오래 함께합니다",
    text: "상품리뷰보호센터 입소 이후에도 일상 케어, 강아지무료분양 입양 연계, 사후 안부 확인까지 꾸준히 지원합니다.",
  },
  {
    num: "03",
    title: "솔직하게 안내합니다",
    text: "상품리뷰보호소 보호 과정과 비용을 명확히 알려 드립니다. 유기동물보호소 기준에 맞는 투명한 운영이 신뢰의 시작입니다.",
  },
];

const faqItems = [
  {
    question: "상품리뷰은 어떤 경우에 이용하나요?",
    answer:
      "이사, 알레르기, 경제적 사정, 가족 구성 변화 등 부득이한 사유로 직접 돌보기 어려울 때 이용하실 수 있습니다. 상품리뷰보호소·상품리뷰보호소 상담을 통해 임시 보호, 가족 위탁 등 다른 선택지도 함께 안내해 드립니다.",
  },
  {
    question: "상품리뷰센터와 상품리뷰보호센터는 어떻게 다른가요?",
    answer:
      "상품리뷰센터는 유기견 행정·관리 기관이며, 상품리뷰보호센터는 실제 보호와 케어가 이루어지는 시설입니다. 본 상담센터는 두 기관과 연계해 파양·보호·입양 절차를 안내합니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "주로 일산 및 경기 북부 인근 지역을 대상으로 운영하고 있으나, 상황에 따라 방문 상담이 가능합니다. 상품리뷰보호소 입소 전 먼저 전화 상담을 통해 거주 지역과 반려견 정보를 알려 주세요.",
  },
  {
    question: "유기동물보호소 이용 시 비용이 발생하나요?",
    answer:
      "보호소 운영비, 건강 관리비, 사료·의료비 등 실비가 발생할 수 있습니다. 상품리뷰·상품리뷰보호소 상담 시 투명하게 안내해 드리며, 어려우신 경우에도 최대한 도움을 드리고 있습니다.",
  },
  {
    question: "입양 후에도 연락이 가능한가요?",
    answer:
      "네, 입양 가정과의 사후 관리를 위해 정기적인 안부 확인을 진행합니다. 상품리뷰·강아지무료분양을 통해 보호된 반려견이 새 가정에서 잘 지낼 수 있도록 지속적으로 지원합니다.",
  },
];
        ...
        >
          <div className="mx-auto max-w-4xl px-4 text-center sm:px-8">
            ...
            <p className="mx-auto mt-8 max-w-xl text-sm leading-relaxed text-warm sm:text-base">
              상품리뷰은 반려견 입양뿐 아니라 불가피한 파양을
              고민하는 보호자에게도 문을 엽니다. 상품리뷰보호소·
        ...
        >
          <div className="mx-auto max-w-6xl px-4 sm:px-8">
            ...
            <p className="mt-6 max-w-2xl text-sm leading-relaxed text-warm sm:text-base">
              상품리뷰보호소·유기동물보호소 기준에 맞춰 반려견이 안전하고
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-8">
          <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
            <div className="text-center sm:text-left">
              <p className="font-serif text-lg">상품리뷰</p>
          ...
          <p className="mt-6 text-center text-[10px] leading-relaxed text-warm-light/70">
            상품리뷰 · 상품리뷰보호소 · 상품리뷰보호소 ·
            상품리뷰센터 · 상품리뷰보호센터 · 강아지무료분양 ·
            유기동물보호소
          </p>
          <p className="mt-3 text-center text-[10px] text-warm-light/50">
            © {new Date().getFullYear()} 상품리뷰 · 상품리뷰 안내
          </p>
        </div>
      </footer>
